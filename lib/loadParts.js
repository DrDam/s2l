...
*/
        ...
        $.ajax({
            ...
            for (var id in data.fuelTanks) {
                ...
                if(id == 'Size1p5_Size0_Adapter_01') tank.stackable.bottom = "1p5";
                if(id == 'Size1p5_Size1_Adapter_01') tank.stackable.bottom = "1p5";
                if(id == 'Size1p5_Size1_Adapter_02') tank.stackable.bottom = "1p5";
                if(id == 'Size1p5_Size2_Adapter_01') tank.stackable.top = "1p5";
                ...
                if(id == 'adapterSize3-Mk3') tank.stackable.top = "mk3";
